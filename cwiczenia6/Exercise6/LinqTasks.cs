    ...
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task6()
        {
            IEnumerable<object> result = Emps.Join(Depts,
                ...
                e2 => e2.Deptno, 
                    (e1, e2) => new { e1, e2 })
                .Select(e => new { e.e1.Ename, e.e1.Job, e.e2.Dname});
        ...
        {
            bool result = (from e in Emps where e.Job == "Backend programmer" select e).Any();
            return result;
        }
        ...
        {
            Emp result = (from e in Emps where e.Job == "Frontend programmer" select e).FirstOrDefault();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                ...
                d => d.Deptno,
                e => e.Deptno,
                (dept, emps) => new { Deptno = dept.Deptno, Dname = dept.Dname, NumOfEmployees = emps.Count() })
                .Where(d => d.NumOfEmployees == 5 || d.NumOfEmployees == 0)
                .OrderBy(d => d.Dname)
                .Select(d => new Dept { Deptno = d.Deptno, Dname = d.Dname })
                .ToList();
